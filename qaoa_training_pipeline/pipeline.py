...
from qaoa_training_pipeline.qaoa_training_pipeline.training import (
    PIPELINE_COMPONENTS,
    PARAMS_PROVIDERS,
)
...
from qaoa_training_pipeline.qaoa_training_pipeline.training.param_result import ParamResult
...
class Pipeline:
    ...
    def execute(
        ...
        for component_idx, component in enumerate(self._pipeline_components):
            ...
            # Update results logging dictionary with the results of the current component
